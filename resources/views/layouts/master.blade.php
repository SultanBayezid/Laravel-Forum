<!DOCTYPE html>
<html lang="en">
  <!-- Mirrored from askbootstrap.com/preview/osahanin/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Dec 2023 14:30:32 GMT -->
  <head>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('template/vendor/slick/slick.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('template/vendor/slick/slick-theme.min.css')}}" />
    <link href="{{asset('template/vendor/icons/feather.css')}}" rel="stylesheet" type="text/css">
  ...
  <body>
        ...
        <ul class="navbar-nav ml-auto d-flex align-items-center">
          ...
          <li class="nav-item">
            <a class="nav-link" href="connection.html">
              ...
              <span class="d-none d-lg-inline">Connection</span>
            </a>
          </li>
          <li class="nav-item dropdown mr-2">
            ...
            <div class="dropdown-menu dropdown-menu-right shadow-sm">
              <a class="dropdown-item" href="jobs.html">
                <i class="feather-briefcase mr-1"></i> Jobs </a>
              <a class="dropdown-item" href="profile.html">
                <i class="feather-user mr-1"></i> Profile </a>
              <a class="dropdown-item" href="connection.html">
                <i class="feather-users mr-1"></i> Connection </a>
              <a class="dropdown-item" href="company-profile.html">
                <i class="feather-user-plus mr-1"></i> Company Profile </a>
              <a class="dropdown-item" href="job-profile.html">
                <i class="feather-globe mr-1"></i> Job Profile </a>
              <a class="dropdown-item" href="messages.html">
                <i class="feather-message-circle mr-1"></i> Messages </a>
              <a class="dropdown-item" href="notifications.html">
                <i class="feather-bell mr-1"></i> Notifications </a>
              <a class="dropdown-item" href="not-found.html">
                <i class="feather-alert-triangle mr-1"></i> 404 Not Found </a>
              <a class="dropdown-item" href="faq.html">
                <i class="feather-help-circle mr-1"></i> FAQ </a>
              <a class="dropdown-item" href="terms.html">
                <i class="feather-book mr-1"></i> Terms </a>
              <a class="dropdown-item" href="privacy.html">
                <i class="feather-list mr-1"></i> Privacy </a>
          ...
          <aside class="col col-xl-3 order-xl-1 col-lg-6 order-lg-2 col-md-6 col-sm-6 col-12">
            <div class="box mb-3 shadow-sm border rounded bg-white profile-box text-center">
              <div class="py-4 px-3 border-bottom">
                <img src="{{asset('template/img/p13.png')}}" class="img-fluid mt-2 rounded-circle" alt="Responsive image">
            ...
            <div class="box mb-3 shadow-sm rounded bg-white view-box overflow-hidden">
              ...
              <div class="overflow-hidden border-top text-center">
                <img src="{{asset('template/img/chart.png')}}" class="img-fluid" alt="Responsive image">
              </div>
            </div>
          ...
          <aside class="col col-xl-3 order-xl-3 col-lg-6 order-lg-3 col-md-6 col-sm-6 col-12">
              ...
              <div class="box-body p-3">
                ...
                <div class="d-flex align-items-center osahan-post-header mb-3 people-list">
                  ...
                  <div class="font-weight-bold mr-2">
                    ...
                    <div class="small text-gray-500">Photographer at Photography </div>
                  </div>
                  <span class="ml-auto">
                    <button type="button" class="btn btn-light btn-sm">
                      <i class="feather-user-plus"></i>
                ...
                <div class="d-flex align-items-center osahan-post-header people-list">
                  ...
                  <div class="font-weight-bold mr-2">
                    ...
                    <div class="small text-gray-500">Graphic Designer at Envato </div>
                  </div>
                  <span class="ml-auto">
                    <button type="button" class="btn btn-light btn-sm">
                      <i class="feather-user-plus"></i>
            ...
            <div class="box shadow-sm border rounded bg-white mb-3">
              <div class="box-title border-bottom p-3 d-flex align-items-center">
                ...
                <a class="ml-auto" href="#">See All <i class="feather-chevron-right"></i>
                </a>
              </div>
              <div class="box-body p-3">
    ...
    <script src="{{asset('template/vendor/jquery/jquery.min.js')}}" type="text/javascript"></script>
    <script src="{{asset('template/vendor/bootstrap/js/bootstrap.bundle.min.js')}}" type="text/javascript"></script>
    <script type="text/javascript" src="{{asset('template/vendor/slick/slick.min.js')}}"></script>
    <script src="{{asset('template/js/osahan.js')}}" type="text/javascript"></script>
    <script type="text/javascript" src="{{asset('template/js/rocket-loader.min.js')}}"></script>
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/v84a3a4012de94ce1a686ba8c167c359c1696973893317" integrity="sha512-euoFGowhlaLqXsPWQ48qSkBSCFs3DPRyiwVu3FjR96cMPx+Fr+gpWRhIafcHwqwCqWS42RZhIudOvEI+Ckf6MA==" data-cf-beacon='{"rayId":"83ca806aeb287872","version":"2023.10.0","r":1,"token":"dd471ab1978346bbb991feaa79e6ce5c","b":1}' crossorigin="anonymous"></script>
  </body>
  <!-- Mirrored from askbootstrap.com/preview/osahanin/light/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 28 Dec 2023 14:30:45 GMT -->
</html>